...
const ContactPage: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-12 lg:gap-10  lg:p-10">
      <div className="col-span-12 lg:col-span-6 pb-6 lg:pb-0 pt-4">
        <div className="border-b pb-4 border-[#d9d9d9]">
          <h1 className="text-3xl lg:text-5xl font-bold text-[#0d0e1d] lg:leading-[3.5rem]">
            Let&apos;s partner to enhance your industrial reliability and
            efficiency.
          </h1>
          <p className="lg:text-xl text-[#0d0e1d] mt-4">
        ...
        <div className="grid grid-cols-12 gap-4 [&>div]:flex [&>div]:flex-col [&>div]:gap-2 [&>div>h2]:text-2xl [&>div>h2]:font-bold [&>div>h2]:text-[#0d0e1d] [&>div>p]:text-[#0d0e1d] [&>div>p]:text-base">
          <div className="col-span-12 lg:col-span-6 pl-0 pr-4 pt-6 pb-6 border-b lg:border-r border-[#d9d9d9]">
          ...
          <div className="col-span-12 lg:col-span-6 lg:p-4">
      ...
      <div className="col-span-12 lg:col-span-6">
        <div className="border border-[#d9d9d9] p-6 lg:p-10">
          <div>
